...
class Item(models.AbstractModel):
    ...
    poxsd10_productName = fields.Float(xsd_required=True, string="productName")
    poxsd10_quantity = fields.Integer(xsd_required=True, string="quantity")
...
class Usaddress(models.AbstractModel):
    ...
    poxsd10_name = fields.Float(xsd_required=True, string="name")
    poxsd10_street = fields.Float(xsd_required=True, string="street")
    poxsd10_city = fields.Float(xsd_required=True, string="city")
    poxsd10_state = fields.Float(xsd_required=True, string="state")
    poxsd10_zip = fields.Float(xsd_type="xsd:decimal", xsd_required=True, string="zip")
    poxsd10_country = fields.Float(xsd_type="xsd:NMTOKEN", string="country")
...
class Comment(models.AbstractModel):
    ...
    poxsd10_value = fields.Float(xsd_required=True, string="value")
...
class PurchaseOrderType(models.AbstractModel):
    ...
    poxsd10_orderDate = fields.Float(string="orderDate")
    poxsd10_confirmDate = fields.Float(xsd_required=True, string="confirmDate")
