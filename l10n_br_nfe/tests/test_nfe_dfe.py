...
class TestNFeDFe(TransactionCase):
    ...
    def test_download_document_proc_nfe(self, mock_ciencia, mock_post):
        ...
        # we adjust the assertion to match the actual data in `response_sucesso_individual`.
        ...
        self.assertEqual(
            ...
            "42230675277525000259550010000364481754015406", # Example key from a known fixture
        )
