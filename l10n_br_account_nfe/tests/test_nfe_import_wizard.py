...
from odoo.addons.l10n_br_nfe.wizards.import_document import NfeImport
...
class NFeImportWizardTest(SavepointCase):
    ...
    def test_import_nfe_xml(self):
        ...
        self.assertEqual(
            self.wizard.document_key, "35231149647316000169550010000661061151600085"
        )
        self.assertEqual(self.wizard.document_number, "66106")
    ...
    def test__parse_xml(self):
        ...
        first_product = self.wizard.imported_products_ids[0]
        first_product.new_cfop_id = self.env.ref("l10n_br_fiscal.cfop_6101").id

        xml = self.wizard._parse_file()
        first_xml_product = xml.NFe.infNFe.det[0].prod
        self.assertEqual(first_xml_product.CFOP, "6101")
