...
# Indica se o valor do ICMS desonerado (vICMSDeson) deduz do valor do
# item (vProd):
...
# direta; 2-Estrangeira - Adquirida no mercado interno; 3-Nacional, conteudo
# superior 40% e inferior ou igual a 70%; 4-Nacional, processos produtivos
...
# interno, sem simular,lista CAMEX;8-Nacional, Conteúdo de Importação
# superior a 70%.
TORIG = [
    ("0", "0"),
    ("1", "1"),
...
CARD_TPINTEGRA = [
    (
        "1",
        (
            "Pagamento integrado com o sistema de automação da empresa (Ex.: "
...
class Di(models.AbstractModel):
    ...
    nfe40_nDI = fields.Char(
        ...
        xsd_required=True,
        help=("Número do Documento de Importação (DI, DSI, DIRE, DUImp) (NT2011/004)"),
    )
    ...
    nfe40_CNPJ = fields.Char(
        string="CNPJ do adquirente ou do encomendante", choice="di", xsd_type="TCnpj"
    )

    nfe40_CPF = fields.Char(
        string="CPF do adquirente ou do encomendante", choice="di", xsd_type="TCpf"
    )
...
class Adi(models.AbstractModel):
    ...
    nfe40_nSeqAdic = fields.Char(string="Número seqüencial do item", xsd_required=True)
...
class DetPag(models.AbstractModel):
    ...
    nfe40_card = fields.Many2one(
        ...
        help=("Grupo de Cartões, PIX, Boletos e outros Pagamentos Eletrônicos"),
    )
...
class Card(models.AbstractModel):
    ...
    nfe40_idTermPag = fields.Char(string="Identificador do terminal de pagamento")
