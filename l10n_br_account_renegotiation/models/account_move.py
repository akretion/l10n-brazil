...
class AccountMove(models.Model):
    ...
    def action_renegotiate_installments(self):
        ...
        if self.state != "posted":
            raise UserError(_("You can only renegotiate installments on posted invoices."))
    ...
    def _get_installment_renegotiation_message(self, old_lines_data, new_lines_data):
        ...
        old_summary = "<br/>".join(format_line(l) for l in old_lines_data)
        new_summary = "<br/>".join(format_line(l) for l in new_lines_data)
